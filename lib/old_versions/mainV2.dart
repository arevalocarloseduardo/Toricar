...
/*
//codigo funciona con la version de maps_google_fluter 0.2.4+5 en el pubspec.yaml 

//Widget para obtener ubicacion
...
class _GetLocationPageState extends State<GetLocationPage> {
  ...
  //declaramos userLocation para guardar los datos recibidos en un map
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: RaisedButton(
                ...
                color: Colors.blue,
                child: Text("Localizar", style: TextStyle(color: Colors.white),),
              ),
            ),
          ],
        ),
  ...
  Future<Map<String, double>> _getLocation() async {
    ...
    try {
      //llamamos la ubicacion esperamos y lo guardamos en currentLocation
